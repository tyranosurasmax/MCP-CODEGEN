 ...
 */
export function registerAdapter(name: string, adapter: SourceAdapter): void {
...
export class UniversalRuntime {
  static registerAdapter(name: string, adapter: SourceAdapter): void {
    registerAdapter(name, adapter);
  }

  static getAdapters(): Map<string, SourceAdapter> {
